...
const { findAllDriversService, searchDriverService, createDriverService, findOneDriverService } = require('../services/drivers.service')
...
module.exports = { getAllDrivers, searchDrivers, createDriver, getDriverByID }
